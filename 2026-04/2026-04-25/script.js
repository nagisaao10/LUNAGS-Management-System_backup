...
});"list-date">${getDate(item).toLocaleDateString()} ${getDate(item).toLocaleTimeString([], { hour: "2-digit", minute: "2-digit" })}</span><p class="list-title">${item.title} / ${item.member}</p></a></div>`
  );
